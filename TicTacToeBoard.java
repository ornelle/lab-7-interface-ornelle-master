...
public class TicTacToeBoard
{
   ...
   */
   public void makeMove(String move, String player)
   {
      ...
      //subtracts the white space and then grabs the first number and then subtracts one from it
      //assumes strategy is between 1-3 but 2d array so subtract 1 so 0-2
   ...
   /**
      Checks to see if the spot is unoccupedied
